...
<head>
	...
	<script type="text/javascript">
		...
		$(document).on( 'scroll', function(){
			mapPosition('.detail img',200,1019,1.5);
		});
		...
		function mapPosition(select,margin_posi,img_posi,posi_fx){
			...
			var img_posi  = mapValue(-200,600,margin_posi-scr_posi_diff-120);
...
<!-- 		<a href="">
			<svg x="0px" y="0px" width="170px" height="26px" viewBox="0 0 170 26">
				...
				<text x="155" y="22" fill="#FFFFFF" text-anchor="end">เกี่ยวกับค่าย</text>
			</svg>
		</a> -->
	...
	<div class="bg" id="bg">
		...
		<div class="top detail" >
			<div id="detail_section" class="content">
				<div class="img left"> 
			...
			<svg x="0px" y="0px" width="1920px" height="2700px" viewBox="0 0 1920 2700">
				<polygon fill="#343434" points="1920,0 1920,1300 0,2700 0,1400"></polygon>
			</svg>
		</div>
		<!-- detail -->
		...
		<!-- pic -->
		<div class="top pic">
			<div id="pic_section" class="content" style="padding-top:40px">
		...
		<!-- spon -->
		<div  class="down spon">
			<div id="spon_section" class="content" style="padding-top:40px" >
				<span class="head" >ผู้สนับสนุน</span><hr>
